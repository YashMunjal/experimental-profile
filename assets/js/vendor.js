const bg = document.querySelector('.background');
        ...
        $(document).ready(function(){
          //var images_urls = ["../assets/images/academics.JPG","../assets/images/mountain.png"]
          
          if($('#P').attr('for')=='checked')
          {
            
            console.log('he');
            $(".blur-bg").css("background", "url(../assets/images/academics.JPG)");
          }
          if($('#Q').attr('checked')=='checked')
          {
            console.log('hey');
            $(".blur-bg").css("background", "url(../assets/images/mountain.png)");
          }
        });